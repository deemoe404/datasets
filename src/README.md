...
- [wind_datasets/visualization.py](./wind_datasets/visualization.py): visualization helpers used by the per-dataset notebooks
- `visualization_kelmarsh.ipynb` / `visualization_penmanshiel.ipynb` / `visualization_hill_of_towie.ipynb` / `visualization_sdwpf_kddcup.ipynb`: generated per-dataset visualization notebooks

The notebooks are generated by `../scripts/generate_visualization_notebooks.py`.
