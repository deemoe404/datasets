...
| 数据集        | 机组数量 | 机组位置信息      | 时间分辨率 | 时间覆盖                 | 机组信息 | 机组特殊 flag   |
| ------------- | -------: | ----------------- | ---------: | -----------------------: | -------: | --------------: |
| Kelmarsh      |        6 | 海拔 + 绝对经纬度 |     10 min | 2016-01-03 - 2025-01-01  |  2050 kW |                 |
| Penmanshiel   |       14 | 海拔 + 绝对经纬度 |     10 min | 2016-01-03 - 2025-01-01* |  2050 kW |                 |
| Hill of Towie |       21 |        绝对经纬度 |     10 min | 2016-01-01 - 2024-09-01  |  2300 kW | AeroUp + TuneUp |
| sdwpf_kddcup  |      134 |          相对坐标 |     10 min | 2020-05-01 - 2020-12-31  |  1500 kW |                 |

*Penmanshiel 中，WT01/02/04/05/06/07/08/09/10 只到 2024-01-01，WT11/12/13/14/15 则继续到 2025-01-01。

| 数据集        | 机组级风功率数据                               |
| ------------- | ---------------------------------------------: |
| Kelmarsh      | Greenbyte 10 分钟 SCADA 功率相关通道           |
| Penmanshiel   | Greenbyte 10 分钟 SCADA 功率相关通道           |
| Hill of Towie | 官方 10 分钟 turbine/grid 统计表中的功率列     |
| sdwpf_kddcup  | 官方主表 `Patv`                                |
