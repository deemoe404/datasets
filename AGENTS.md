...
| ------------- | -------: | ----------------- | ---------: | ----------------------------------: | -------: |
| Kelmarsh      |        6 | 绝对经纬度 + 海拔 |     10 min |     mean/min/max/stddev over 10 min |  2050 kW |
| Penmanshiel   |       14 | 绝对经纬度 + 海拔 |     10 min |     mean/min/max/stddev over 10 min |  2050 kW |
| Hill of Towie |       21 | 绝对经纬度        |     10 min | mean/min/max/stddev/end over 10 min |  2300 kW |
| SDWPF_full    |      134 |   相对坐标 + 海拔 |     10 min |                    mean over 10 min |  1500 kW |

Kelmarsh/Penmanshiel 的 Greenbyte 连续 CSV 不是天然一条时间戳一行，同一时间戳会出现很多条记录，必须先聚合整理
Hill of Towie 的月表在月边界有重复行，需要去重
