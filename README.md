...
| `tblSCTurbine` | `TimeStamp`, `StationId`, `wtc_AcWindSp_mean`, `wtc_GenRpm_mean`, `wtc_MainSRpm_mean`, `wtc_PitchRef_BladeA_mean`, `wtc_PitchRef_BladeB_mean`, `wtc_PitchRef_BladeC_mean`, `wtc_PriAnemo_mean`, `wtc_SecAnemo_mean`, `wtc_TwrHumid_mean`, `wtc_YawPos_mean` |
