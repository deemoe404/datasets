...
def build_hill_fixture(root: Path) -> DatasetSpec:
    ...
    _write_text(
        ...
        2024-01-01 00:00:00,1001,7.0,ok
        2024-01-01 00:00:00,1002,6.5,ok
        2024-01-01 00:10:00,1001,7.2,ok
        2024-01-01 00:10:00,1002,6.7,ok
        2024-01-01 00:20:00,1001,7.4,ok
        2024-01-01 00:20:00,1002,6.8,ok
        2024-01-01 00:30:00,1001,7.6,ok
        2024-01-01 00:30:00,1002,7.0,ok
        2024-01-01 00:40:00,1001,7.8,ok
        2024-01-01 00:40:00,1002,7.2,ok
        2024-01-01 00:50:00,1001,8.0,ok
        2024-01-01 00:50:00,1002,7.4,OK
        2024-01-01 00:50:00,1002,7.4, OK
        2024-01-01 01:00:00,1001,8.1,conflict
        2024-01-01 01:00:00,1001,8.2,conflict
        2024-01-01 01:00:00,1002,7.5,ok
        """,
    )
    _write_text(
