...
\texttt{target\_kw} & $y^{pu}$ & 机组 10 分钟平均 per-unit 功率，对应原始字段 \texttt{Power (kW)}；下文统一记 $y^{pu}_{i,t}=target\_kw_{i,t}/rated\_power_i$ \\
\end{tabularx}
...
沿用第 1 节数据说明表中约定的目标量与本地观测记号，当前机组观测向量写为
\begin{equation}
  o_{i,t}=\left[
  \begin{aligned}
