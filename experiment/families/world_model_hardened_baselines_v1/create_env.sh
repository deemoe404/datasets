...
echo "world_model_hardened_baselines_v1 environment is ready at ${ENV_PREFIX}"
echo "Run the experiment with:"
echo "  ${ENV_PREFIX}/bin/python ${SCRIPT_DIR}/run_world_model_hardened_baselines_v1.py"
