...
def require_torch() -> Any:
    if torch is None:
        raise ImportError(
            ...
            "Create experiment/families/tft/.conda with ./create_env.sh."
        )
    return torch
...
def build_arg_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Optional label suffix for the formal run record under experiment/artifacts/runs/tft_turbine_pilot/.",
    )
    parser.add_argument(
        "--no-record-run",
        action="store_true",
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    if not args.no_record_run:
        record_cli_run(
            ...
            entrypoint="experiment/families/tft/run_tft.py",
            args=vars(args),
            output_path=args.output_path,
            ...
            artifacts={"job_artifacts_root": _JOB_ARTIFACTS_ROOT},
