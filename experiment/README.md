...
- [world_model_hardened_baselines_v1](./families/world_model_hardened_baselines_v1/README.md): `kelmarsh` only, farm-synchronous, hardened official/official-core baseline track with external source provenance for persistence, DGCRN, TimeXer, iTransformer, and Chronos-2 (`world_model_v1`)
