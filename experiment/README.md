...
- `agcrn_official_aligned` still consumes the original 9 experiment protocols only; the dataset-side `power_wd_yaw_pmean_hist_sincos_masked` protocol is not wired into the AGCRN family registry, variants, or runner in this repository state.
