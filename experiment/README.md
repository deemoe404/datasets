...
- [world_model_baselines_v1](./families/world_model_baselines_v1/README.md): `kelmarsh` only, farm-synchronous, persistence plus shared-weight TFT-no-graph, TimeXer-no-graph, and DGCRN-style dynamic-graph baselines (`world_model_v1`)
